...
class DSTN(nn.Module):
    ...
    def __init__(self, adj, hidden_dim, scaler, spectrum_similarity_matrix, time_delay_matrix, epsilon, sample_rate):
        ...
        self.dgcn_cell = DGCN_cell(self.adj, self.num_nodes, self.hidden_dim, self.scaler, self.spectrum_similarity_matrix, self.time_delay_matrix, self.sample_rate)
    ...
    def forward(self, inputs):
        ...
        for i in range(seq_len - 9):
            ...
            output, encoder_state = self.dgcn_cell(encoder_inputs, encoder_states, observed = True)
            ...
            for j in range (seq_len-i-1):
                ...
                pred,decoder_state = self.dgcn_cell(decoder_inputs, decoder_states, observed = False)
